...
function fitness_elementor_logo_resizer() {
    ...
    $fitness_elementor_logo_resizer = get_theme_mod('fitness_elementor_logo_resizer');

	$fitness_elementor_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($fitness_elementor_logo_resizer).'px !important;
			width: '.esc_attr($fitness_elementor_logo_resizer).'px !important;
		}
	';
...
define('FITNESS_ELEMENTOR_FREE_THEME_DOC',__('https://www.wpelemento.com/theme-documentation/fitness-elementor/','fitness-elementor'));
...
define('FITNESS_ELEMENTOR_BUY_NOW',__('https://www.wpelemento.com/elementor/fitness-wordpress-theme/','fitness-elementor'));
define('FITNESS_ELEMENTOR_LIVE_DEMO',__('https://www.wpelemento.com/demo/fitness-elementor/','fitness-elementor'));
define('FITNESS_ELEMENTOR_THEME_BUNDLE',__('https://www.wpelemento.com/elementor/wordpress-theme-bundle/','fitness-elementor'));
